...
export default class DocumentSelectCard extends Component {
    ...
    constructor(){
        ...
        this.rdfaBlock = this.info.rdfaBlock;
        this.hintsRegistry = this.info.hintsRegistry;
    ...
    async decisionDocumentClicked(decisionDocument){
        if (this.isNewList) {
            ...
            this.hintsRegistry.removeHintsAtLocation(this.location);
        ...
        console.log(this.rdfaBlock);
        this.hintsRegistry.removeHintsInRegion(this.editor.richNode.region);
